...
-- Tiempo de generación: 29-09-2007 a las 06:05:53
...
CREATE TABLE IF NOT EXISTS `meanings` (
  ...
  `morphologic_id` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `hidden` (`hidden`),
  KEY `check_count` (`check_count`),
  KEY `super_id` (`super_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs AUTO_INCREMENT=8239 ;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `morphologics`
--

CREATE TABLE IF NOT EXISTS `morphologics` (
  `id` int(11) NOT NULL auto_increment,
  `morphologic` varchar(50) collate latin1_general_cs NOT NULL default '',
  `explanation` varchar(255) collate latin1_general_cs NOT NULL default '',
  PRIMARY KEY  (`id`),
  FULLTEXT KEY `morphologic` (`morphologic`)
...
CREATE TABLE IF NOT EXISTS `search_log` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs AUTO_INCREMENT=47176 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs AUTO_INCREMENT=32 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs AUTO_INCREMENT=41091 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs AUTO_INCREMENT=23778 ;
...
CREATE TABLE IF NOT EXISTS `word_meanings` (
  ...
  KEY `use_id` (`use_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs AUTO_INCREMENT=47128 ;
